...
## $350,000 - Monthly Progress Prizes

Monthly prizes of $1,000-20,000 for open-ended submissions that get us closer to reading 90% of Scrolls 1-4. This is a great place to start if you are new to the project, and we have a wishlist to provide some ideas. Progress prizes will be awarded at a range of levels based on the contribution:
...
We favor submissions that actually **get used**. We’ll look for signals from the community: questions, comments, bug reports, feature requests. Our Segmentation Team will publicly comment on tools they use and can provide private feedback upon request.
...
## 4 x $30,000 - First Title Prize + 3 First Letters Prizes
...
## $100,000 - First Automated Segmentation Prize
